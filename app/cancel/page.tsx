     ...
     // <section className="bg-primary-50 bg-dotted-pattern bg-contain py-5 md:py-10">
        ...
        <div className="wrapper grid grid-cols-1 gap-5 md:grid-cols-2 2xl:gap-0">
          <div className="flex flex-col justify-center gap-8">
            <h1 className="h1-bold text-red-600">Payment Cancelled</h1>
            <p className="p-regular-20 md:p-regular-24">Your payment was cancelled. Please try again or contact support if you need help.</p>
            <div className="flex gap-4">
              ...
              <Button size="lg" variant="outline" asChild className="button w-full sm:w-fit">
                <Link href="/blank/pay">
                  Try Again
                </Link>
              </Button>
